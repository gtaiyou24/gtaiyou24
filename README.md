...
| リポジトリ | 説明 |
|:---------|:-----|
| fashion-image-analyzer | ファッション画像を解析し、アイテムのカラー/画像タイプ/性別を予測するサービス |
| fashion-image-searcher | ファッション画像検索サービス |
| size-fit | ファッションアイテムのサイズ情報を入力すると、自分の体系に合ったサイズを予測するサービス |
| ayame | ファッションコーディネートをするサービス |
| fashion-reviwer | ファッションアイテムを入力するとレビューして、レビューを自動生成するサービス |

### 👨‍🎓 Research - 研究・勉強

| リポジトリ | 説明 |
|:---------|:-----|
| text-generator | AIチャットサービス |
